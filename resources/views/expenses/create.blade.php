<x-app-layout>
    ...
    <div class="flex items-center gap-4 mb-6">
        ...
        <h2 class="text-2xl font-bold text-white">Tambah Pengeluaran</h2>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="category"
                        ...
                        <option value="Servis" {{ old('category') == 'Servis' ? 'selected' : '' }}>Servis</option>
                        <option value="Ban" {{ old('category') == 'Ban' ? 'selected' : '' }}>Ban</option>
                        <option value="Oli" {{ old('category') == 'Oli' ? 'selected' : '' }}>Oli</option>
                        <option value="Modifikasi" {{ old('category') == 'Modifikasi' ? 'selected' : '' }}>Modifikasi</option>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="description" value="{{ old('description') }}"
                           placeholder="Ganti ban depan, bayar pajak tahunan..."
                           class="w-full bg-surface-700 border border-surface-600 text-white rounded-lg px-4 py-2 focus:outline-none focus:border-primary">
                </div>
